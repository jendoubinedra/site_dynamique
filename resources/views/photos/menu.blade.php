			...
			<div class="sidebar-inner slimscroll">
				<div id="sidebar-menu" class="sidebar-menu">
					<ul>
						...
						<li class="submenu"> <a href="#"><i class="fas fa-user"></i> <span> Photo </span> <span class="menu-arrow"></span></a>
							<ul class="submenu_class" style="display: none;">
                                <li><a href="{{route('addphotos.store')}}"> add photo  </a></li>
                                <li><a href="{{route('listephoto.index')}}"> liste des pages </a></li>
